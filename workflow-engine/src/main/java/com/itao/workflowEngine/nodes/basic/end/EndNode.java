package com.itao.workflowEngine.nodes.basic.end;

import com.itao.util.StringValueUtils;
...
import com.itao.workflowEngine.common.enums.NodeGroupParamValueTypeEnum;
    ...
    public Map<String, Object> _run(String uniqueId) {
        ...
        if (outputVariables instanceof List<?> mappings) {
            for (Object mapping : mappings) {
                ...
                if (StringValueUtils.isBlank(key)) {
                    continue;
                }
